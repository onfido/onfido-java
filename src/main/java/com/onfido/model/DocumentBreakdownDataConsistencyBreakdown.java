...
public class DocumentBreakdownDataConsistencyBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("date_of_expiry", "document_numbers", "issuing_country", "document_type", "date_of_birth", "gender", "first_name", "nationality", "last_name", "multiple_data_sources_present"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentBreakdownDataConsistencyBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentBreakdownDataConsistencyBreakdown is not found in the empty JSON string", DocumentBreakdownDataConsistencyBreakdown.openapiRequiredFields.toString()));
        }
      }
