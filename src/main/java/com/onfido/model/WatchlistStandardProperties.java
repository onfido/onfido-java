...
public class WatchlistStandardProperties {
  ...
  @Deprecated
  public WatchlistStandardProperties records(@javax.annotation.Nullable List<Object> records) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistStandardProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WatchlistStandardProperties is not found in the empty JSON string", WatchlistStandardProperties.openapiRequiredFields.toString()));
        }
      }
