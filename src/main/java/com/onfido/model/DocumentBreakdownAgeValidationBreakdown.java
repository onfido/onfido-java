...
public class DocumentBreakdownAgeValidationBreakdown {
  ...
  static {
    ...
    openapiFields.add("minimum_accepted_age");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentBreakdownAgeValidationBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentBreakdownAgeValidationBreakdown is not found in the empty JSON string", DocumentBreakdownAgeValidationBreakdown.openapiRequiredFields.toString()));
        }
      }
