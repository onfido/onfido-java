...
- Release based on Onfido OpenAPI spec version [v6.0.0](https://github.com/onfido/onfido-openapi-spec/releases/tag/v6.0.0):
  ...
  - [CAT-2382] Enable useSingleRequestParameter for Java Client Generator
  - [CAT-2201] Solve security alert in onfido-java client library

## v6.7.0 3rd February 2026
