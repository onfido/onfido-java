...
public class WatchlistAmlBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sanction", "politically_exposed_person", "legal_and_regulatory_warnings", "adverse_media"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistAmlBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WatchlistAmlBreakdown is not found in the empty JSON string", WatchlistAmlBreakdown.openapiRequiredFields.toString()));
        }
      }
