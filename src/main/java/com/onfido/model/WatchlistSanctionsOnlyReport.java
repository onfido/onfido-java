...
public class WatchlistSanctionsOnlyReport {
  ...
  public WatchlistSanctionsOnlyReport id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public WatchlistSanctionsOnlyReport createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public WatchlistSanctionsOnlyReport href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public WatchlistSanctionsOnlyReport status(@javax.annotation.Nullable ReportStatus status) {
    this.status = status;
    return this;
  }
  ...
  public WatchlistSanctionsOnlyReport result(@javax.annotation.Nullable ReportResult result) {
    this.result = result;
    return this;
  }
  ...
  public WatchlistSanctionsOnlyReport subResult(@javax.annotation.Nullable ReportSubResult subResult) {
  ...
  public WatchlistSanctionsOnlyReport checkId(@javax.annotation.Nullable UUID checkId) {
  ...
  public WatchlistSanctionsOnlyReport name(@javax.annotation.Nonnull ReportName name) {
    this.name = name;
    return this;
  }
  ...
  public WatchlistSanctionsOnlyReport breakdown(@javax.annotation.Nullable WatchlistStandardBreakdown breakdown) {
  ...
  public WatchlistSanctionsOnlyReport properties(@javax.annotation.Nullable WatchlistStandardProperties properties) {
   ...
   * @return the WatchlistSanctionsOnlyReport instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to WatchlistSanctionsOnlyReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistSanctionsOnlyReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WatchlistSanctionsOnlyReport is not found in the empty JSON string", WatchlistSanctionsOnlyReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WatchlistSanctionsOnlyReport.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WatchlistSanctionsOnlyReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WatchlistSanctionsOnlyReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WatchlistSanctionsOnlyReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WatchlistSanctionsOnlyReport.class));

       return (TypeAdapter<T>) new TypeAdapter<WatchlistSanctionsOnlyReport>() {
           @Override
           public void write(JsonWriter out, WatchlistSanctionsOnlyReport value) throws IOException {
           ...
           @Override
           public WatchlistSanctionsOnlyReport read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             WatchlistSanctionsOnlyReport instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of WatchlistSanctionsOnlyReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WatchlistSanctionsOnlyReport
   * @throws IOException if the JSON string is invalid with respect to WatchlistSanctionsOnlyReport
   */
  public static WatchlistSanctionsOnlyReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WatchlistSanctionsOnlyReport.class);
  }

  /**
   * Convert an instance of WatchlistSanctionsOnlyReport to an JSON string
   *
   * @return JSON string
   */
