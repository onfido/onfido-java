...
public class ApplicantBuilder {
  ...
  **/
  ...
  public ApplicantBuilder consents(List<ApplicantConsent> consents) {
    this.consents = consents;
    return this;
  }

  public ApplicantBuilder addConsentsItem(ApplicantConsent consentsItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<ApplicantConsent> getConsents() {
    return consents;
  }

  public void setConsents(List<ApplicantConsent> consents) {
    this.consents = consents;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicantBuilder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicantBuilder is not found in the empty JSON string", ApplicantBuilder.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("consents") != null && !jsonObj.get("consents").isJsonNull()) {
        ...
        if (jsonArrayconsents != null) {
          ...
          for (int i = 0; i < jsonArrayconsents.size(); i++) {
            ApplicantConsent.validateJsonElement(jsonArrayconsents.get(i));
          };
        }
      }
