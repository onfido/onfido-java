...
public class IdentityEnhancedBreakdownAddressBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("credit_agencies", "telephone_database", "voting_register"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdentityEnhancedBreakdownAddressBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IdentityEnhancedBreakdownAddressBreakdown is not found in the empty JSON string", IdentityEnhancedBreakdownAddressBreakdown.openapiRequiredFields.toString()));
        }
      }
