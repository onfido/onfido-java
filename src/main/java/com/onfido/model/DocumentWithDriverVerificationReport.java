 ...
 */
@JsonPropertyOrder({
  DocumentWithDriverVerificationReport.JSON_PROPERTY_ID,
  DocumentWithDriverVerificationReport.JSON_PROPERTY_CREATED_AT,
  DocumentWithDriverVerificationReport.JSON_PROPERTY_HREF,
  DocumentWithDriverVerificationReport.JSON_PROPERTY_STATUS,
  DocumentWithDriverVerificationReport.JSON_PROPERTY_RESULT,
  DocumentWithDriverVerificationReport.JSON_PROPERTY_SUB_RESULT,
  DocumentWithDriverVerificationReport.JSON_PROPERTY_CHECK_ID,
  DocumentWithDriverVerificationReport.JSON_PROPERTY_DOCUMENTS,
  DocumentWithDriverVerificationReport.JSON_PROPERTY_NAME,
  DocumentWithDriverVerificationReport.JSON_PROPERTY_BREAKDOWN,
  DocumentWithDriverVerificationReport.JSON_PROPERTY_PROPERTIES
})
@JsonTypeName("document_with_driver_verification_report")
...
public class DocumentWithDriverVerificationReport {
  ...
  **/
  ...
  public DocumentWithDriverVerificationReport name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this document_with_driver_verification_report object is equal to o.
   */
  @Override
