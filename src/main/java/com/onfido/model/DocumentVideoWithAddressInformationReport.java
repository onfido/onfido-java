 ...
 */
@JsonPropertyOrder({
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_ID,
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_CREATED_AT,
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_HREF,
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_STATUS,
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_RESULT,
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_SUB_RESULT,
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_CHECK_ID,
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_DOCUMENTS,
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_NAME,
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_BREAKDOWN,
  DocumentVideoWithAddressInformationReport.JSON_PROPERTY_PROPERTIES
})
@JsonTypeName("document_video_with_address_information_report")
...
public class DocumentVideoWithAddressInformationReport {
  ...
  **/
  ...
  public DocumentVideoWithAddressInformationReport name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this document_video_with_address_information_report object is equal to o.
   */
  @Override
