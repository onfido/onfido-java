 ...
 */
@JsonPropertyOrder({
  DocumentVideoReport.JSON_PROPERTY_ID,
  DocumentVideoReport.JSON_PROPERTY_CREATED_AT,
  DocumentVideoReport.JSON_PROPERTY_HREF,
  DocumentVideoReport.JSON_PROPERTY_STATUS,
  DocumentVideoReport.JSON_PROPERTY_RESULT,
  DocumentVideoReport.JSON_PROPERTY_SUB_RESULT,
  DocumentVideoReport.JSON_PROPERTY_CHECK_ID,
  DocumentVideoReport.JSON_PROPERTY_DOCUMENTS,
  DocumentVideoReport.JSON_PROPERTY_NAME,
  DocumentVideoReport.JSON_PROPERTY_BREAKDOWN,
  DocumentVideoReport.JSON_PROPERTY_PROPERTIES
})
@JsonTypeName("document_video_report")
...
public class DocumentVideoReport {
  ...
  **/
  ...
  public DocumentVideoReport name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this document_video_report object is equal to o.
   */
  @Override
