...
public class WorkflowRunOutputsTest extends TestBase {
  ...
  public void documentAndFacialSimilarityReportsAsOutputs() throws Exception {
    ...
    onfido
        .completeTask(workflowRunId, documentCaptureTaskId, completeDocumentCaptureTaskBuilder)
        .execute();
    ...
    onfido
        .completeTask(workflowRunId, photoCaptureTaskId, completeLivePhotoCaptureTaskBuilder)
        .execute();
