...
public class DocumentPropertiesDocumentNumbersInner {
   ...
   * @return the DocumentPropertiesDocumentNumbersInner instance itself
   */
  public DocumentPropertiesDocumentNumbersInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, documentPropertiesDocumentNumbersInner.value) &&
        ...
        Objects.equals(this.additionalProperties, documentPropertiesDocumentNumbersInner.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentPropertiesDocumentNumbersInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentPropertiesDocumentNumbersInner is not found in the empty JSON string", DocumentPropertiesDocumentNumbersInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentPropertiesDocumentNumbersInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentPropertiesDocumentNumbersInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentPropertiesDocumentNumbersInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentPropertiesDocumentNumbersInner.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentPropertiesDocumentNumbersInner>() {
           @Override
           public void write(JsonWriter out, DocumentPropertiesDocumentNumbersInner value) throws IOException {
           ...
           @Override
           public DocumentPropertiesDocumentNumbersInner read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DocumentPropertiesDocumentNumbersInner instance = thisAdapter.fromJsonTree(jsonObj);
