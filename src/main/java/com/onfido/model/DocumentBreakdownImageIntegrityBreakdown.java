...
public class DocumentBreakdownImageIntegrityBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("image_quality", "supported_document", "colour_picture", "conclusive_document_quality"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentBreakdownImageIntegrityBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentBreakdownImageIntegrityBreakdown is not found in the empty JSON string", DocumentBreakdownImageIntegrityBreakdown.openapiRequiredFields.toString()));
        }
      }
