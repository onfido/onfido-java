...
public class WorkflowRunError {
  ...
  public WorkflowRunError type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public WorkflowRunError message(@javax.annotation.Nullable String message) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowRunError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WorkflowRunError is not found in the empty JSON string", WorkflowRunError.openapiRequiredFields.toString()));
        }
      }
