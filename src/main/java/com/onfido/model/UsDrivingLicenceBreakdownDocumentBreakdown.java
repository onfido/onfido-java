...
public class UsDrivingLicenceBreakdownDocumentBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("category", "expiration_date", "issue_date", "document_number"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsDrivingLicenceBreakdownDocumentBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UsDrivingLicenceBreakdownDocumentBreakdown is not found in the empty JSON string", UsDrivingLicenceBreakdownDocumentBreakdown.openapiRequiredFields.toString()));
        }
      }
