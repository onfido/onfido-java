...
public class WebhookCreate {
   ...
   * @return the WebhookCreate instance itself
   */
  public WebhookCreate putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WebhookCreate is not found in the empty JSON string", WebhookCreate.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookCreate>() {
           ...
           public WebhookCreate read(JsonReader in) throws IOException {
             ...
             WebhookCreate instance = thisAdapter.fromJsonTree(jsonObj);
