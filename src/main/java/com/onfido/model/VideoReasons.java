...
public class VideoReasons {
   ...
   * @return the VideoReasons instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fakeWebcam, videoReasons.fakeWebcam) &&
        ...
        Objects.equals(this.additionalProperties, videoReasons.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fakeWebcam, challengeReuse, emulator, reasons, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fake_webcam", "challenge_reuse", "emulator", "reasons"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoReasons.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in VideoReasons is not found in the empty JSON string", VideoReasons.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("challenge_reuse") != null && !jsonObj.get("challenge_reuse").isJsonNull()) && !jsonObj.get("challenge_reuse").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `challenge_reuse` to be a primitive type in the JSON string but got `%s`", jsonObj.get("challenge_reuse").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoReasons.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoReasons' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoReasons> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoReasons.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoReasons>() {
           @Override
           public void write(JsonWriter out, VideoReasons value) throws IOException {
           ...
           @Override
           public VideoReasons read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             VideoReasons instance = thisAdapter.fromJsonTree(jsonObj);
