...
public class DeviceIntelligenceBreakdownBreakdown {
   ...
   * @return the DeviceIntelligenceBreakdownBreakdown instance itself
   */
  public DeviceIntelligenceBreakdownBreakdown putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeviceIntelligenceBreakdownBreakdown deviceIntelligenceBreakdownBreakdown = (DeviceIntelligenceBreakdownBreakdown) o;
    return Objects.equals(this.device, deviceIntelligenceBreakdownBreakdown.device)&&
        Objects.equals(this.additionalProperties, deviceIntelligenceBreakdownBreakdown.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceIntelligenceBreakdownBreakdown {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceIntelligenceBreakdownBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeviceIntelligenceBreakdownBreakdown is not found in the empty JSON string", DeviceIntelligenceBreakdownBreakdown.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeviceIntelligenceBreakdownBreakdown.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeviceIntelligenceBreakdownBreakdown' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeviceIntelligenceBreakdownBreakdown> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeviceIntelligenceBreakdownBreakdown.class));

       return (TypeAdapter<T>) new TypeAdapter<DeviceIntelligenceBreakdownBreakdown>() {
           @Override
           public void write(JsonWriter out, DeviceIntelligenceBreakdownBreakdown value) throws IOException {
           ...
           @Override
           public DeviceIntelligenceBreakdownBreakdown read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DeviceIntelligenceBreakdownBreakdown instance = thisAdapter.fromJsonTree(jsonObj);
