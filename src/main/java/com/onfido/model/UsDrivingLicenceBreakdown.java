...
public class UsDrivingLicenceBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("document", "address", "personal"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsDrivingLicenceBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UsDrivingLicenceBreakdown is not found in the empty JSON string", UsDrivingLicenceBreakdown.openapiRequiredFields.toString()));
        }
      }
