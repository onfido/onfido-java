  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistPepsOnlyReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WatchlistPepsOnlyReport is not found in the empty JSON string", WatchlistPepsOnlyReport.openapiRequiredFields.toString()));
        }
      }
