...
public class ApplicantConsent {
  ...
  public ApplicantConsent name(@javax.annotation.Nonnull ApplicantConsentName name) {
    this.name = name;
    return this;
  }
  ...
  public ApplicantConsent granted(@javax.annotation.Nonnull Boolean granted) {
  ...
  public ApplicantConsent grantedAt(@javax.annotation.Nullable OffsetDateTime grantedAt) {
  ...
  public void setGrantedAt(@javax.annotation.Nullable OffsetDateTime grantedAt) {
    this.grantedAt = grantedAt;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, applicantConsent.name) &&
        ...
        Objects.equals(this.grantedAt, applicantConsent.grantedAt)&&
        Objects.equals(this.additionalProperties, applicantConsent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, granted, grantedAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "granted", "granted_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "granted", "granted_at"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicantConsent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ApplicantConsent is not found in the empty JSON string", ApplicantConsent.openapiRequiredFields.toString()));
        }
      }
