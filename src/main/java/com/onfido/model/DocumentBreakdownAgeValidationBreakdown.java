...
public class DocumentBreakdownAgeValidationBreakdown {
   ...
   * @return the DocumentBreakdownAgeValidationBreakdown instance itself
   */
  public DocumentBreakdownAgeValidationBreakdown putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.minimumAcceptedAge, documentBreakdownAgeValidationBreakdown.minimumAcceptedAge)&&
        Objects.equals(this.additionalProperties, documentBreakdownAgeValidationBreakdown.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(minimumAcceptedAge, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("minimum_accepted_age"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentBreakdownAgeValidationBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentBreakdownAgeValidationBreakdown is not found in the empty JSON string", DocumentBreakdownAgeValidationBreakdown.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `minimum_accepted_age`
      if (jsonObj.get("minimum_accepted_age") != null && !jsonObj.get("minimum_accepted_age").isJsonNull()) {
        DocumentBreakdownDataComparisonBreakdownIssuingCountry.validateJsonElement(jsonObj.get("minimum_accepted_age"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentBreakdownAgeValidationBreakdown.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentBreakdownAgeValidationBreakdown' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentBreakdownAgeValidationBreakdown> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentBreakdownAgeValidationBreakdown.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentBreakdownAgeValidationBreakdown>() {
           @Override
           public void write(JsonWriter out, DocumentBreakdownAgeValidationBreakdown value) throws IOException {
           ...
           @Override
           public DocumentBreakdownAgeValidationBreakdown read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DocumentBreakdownAgeValidationBreakdown instance = thisAdapter.fromJsonTree(jsonObj);
