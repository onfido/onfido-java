...
public class LiveVideosList {
  ...
  public LiveVideosList liveVideos(@javax.annotation.Nonnull List<LiveVideo> liveVideos) {
  ...
  public void setLiveVideos(@javax.annotation.Nonnull List<LiveVideo> liveVideos) {
    this.liveVideos = liveVideos;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("live_videos"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("live_videos"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LiveVideosList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in LiveVideosList is not found in the empty JSON string", LiveVideosList.openapiRequiredFields.toString()));
        }
      }
