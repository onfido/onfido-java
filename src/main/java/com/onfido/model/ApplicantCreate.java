...
public class ApplicantCreate {
  ...
  public ApplicantCreate firstName(@javax.annotation.Nonnull String firstName) {
  ...
  public ApplicantCreate lastName(@javax.annotation.Nonnull String lastName) {
   ...
   * @return the ApplicantCreate instance itself
   */
  public ApplicantCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.firstName, applicantCreate.firstName) &&
        ...
        Objects.equals(this.additionalProperties, applicantCreate.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicantCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ApplicantCreate is not found in the empty JSON string", ApplicantCreate.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplicantCreate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicantCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicantCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicantCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicantCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicantCreate>() {
           @Override
           public void write(JsonWriter out, ApplicantCreate value) throws IOException {
           ...
           @Override
           public ApplicantCreate read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ApplicantCreate instance = thisAdapter.fromJsonTree(jsonObj);
