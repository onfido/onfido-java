...
public class IdentityEnhancedReport {
   ...
   * @return the IdentityEnhancedReport instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to IdentityEnhancedReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdentityEnhancedReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IdentityEnhancedReport is not found in the empty JSON string", IdentityEnhancedReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IdentityEnhancedReport.openapiRequiredFields) {
      ...
      if (jsonObj.get("breakdown") != null && !jsonObj.get("breakdown").isJsonNull()) {
        IdentityEnhancedBreakdown.validateJsonElement(jsonObj.get("breakdown"));
      }
      // validate the optional field `properties`
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        IdentityEnhancedProperties.validateJsonElement(jsonObj.get("properties"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IdentityEnhancedReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IdentityEnhancedReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IdentityEnhancedReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IdentityEnhancedReport.class));

       return (TypeAdapter<T>) new TypeAdapter<IdentityEnhancedReport>() {
           @Override
           public void write(JsonWriter out, IdentityEnhancedReport value) throws IOException {
           ...
           @Override
           public IdentityEnhancedReport read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             IdentityEnhancedReport instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of IdentityEnhancedReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IdentityEnhancedReport
   * @throws IOException if the JSON string is invalid with respect to IdentityEnhancedReport
   */
  public static IdentityEnhancedReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IdentityEnhancedReport.class);
  }

  /**
   * Convert an instance of IdentityEnhancedReport to an JSON string
   *
   * @return JSON string
   */
