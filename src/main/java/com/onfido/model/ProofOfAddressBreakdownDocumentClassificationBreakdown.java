...
public class ProofOfAddressBreakdownDocumentClassificationBreakdown {
   ...
   * @return the ProofOfAddressBreakdownDocumentClassificationBreakdown instance itself
   */
  public ProofOfAddressBreakdownDocumentClassificationBreakdown putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProofOfAddressBreakdownDocumentClassificationBreakdown proofOfAddressBreakdownDocumentClassificationBreakdown = (ProofOfAddressBreakdownDocumentClassificationBreakdown) o;
    return Objects.equals(this.supportedDocument, proofOfAddressBreakdownDocumentClassificationBreakdown.supportedDocument)&&
        Objects.equals(this.additionalProperties, proofOfAddressBreakdownDocumentClassificationBreakdown.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(supportedDocument, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProofOfAddressBreakdownDocumentClassificationBreakdown {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("supported_document"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProofOfAddressBreakdownDocumentClassificationBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ProofOfAddressBreakdownDocumentClassificationBreakdown is not found in the empty JSON string", ProofOfAddressBreakdownDocumentClassificationBreakdown.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("supported_document") != null && !jsonObj.get("supported_document").isJsonNull()) {
        DocumentBreakdownDataComparisonBreakdownIssuingCountry.validateJsonElement(jsonObj.get("supported_document"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProofOfAddressBreakdownDocumentClassificationBreakdown.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProofOfAddressBreakdownDocumentClassificationBreakdown' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProofOfAddressBreakdownDocumentClassificationBreakdown> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProofOfAddressBreakdownDocumentClassificationBreakdown.class));

       return (TypeAdapter<T>) new TypeAdapter<ProofOfAddressBreakdownDocumentClassificationBreakdown>() {
           @Override
           public void write(JsonWriter out, ProofOfAddressBreakdownDocumentClassificationBreakdown value) throws IOException {
           ...
           @Override
           public ProofOfAddressBreakdownDocumentClassificationBreakdown read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ProofOfAddressBreakdownDocumentClassificationBreakdown instance = thisAdapter.fromJsonTree(jsonObj);
