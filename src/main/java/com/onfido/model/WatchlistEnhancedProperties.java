 ...
 */
@JsonPropertyOrder({
  WatchlistEnhancedProperties.JSON_PROPERTY_RECORDS
})
@JsonTypeName("watchlist_enhanced_properties")
...
public class WatchlistEnhancedProperties {
  ...
  **/
  ...
  /**
   * Return true if this watchlist_enhanced_properties object is equal to o.
   */
  @Override
