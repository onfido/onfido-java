...
```groovy
  ...
  dependencies {
     implementation "com.onfido:onfido-api-java:6.2.0"
  }
```
...
- `target/onfido-api-java-6.2.0.jar`
- `target/lib/*.jar`

The latest version can be found at <https://search.maven.org/artifact/com.onfido/onfido-api-java/6.2.0/jar>.
