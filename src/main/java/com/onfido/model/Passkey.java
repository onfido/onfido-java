...
public class Passkey {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "application_domain", "state", "created_at", "last_used_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "application_domain", "state", "created_at"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Passkey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Passkey is not found in the empty JSON string", Passkey.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("application_domain").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `application_domain` to be a primitive type in the JSON string but got `%s`", jsonObj.get("application_domain").toString()));
      }
