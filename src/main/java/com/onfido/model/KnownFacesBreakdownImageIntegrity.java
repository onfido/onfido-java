...
public class KnownFacesBreakdownImageIntegrity {
   ...
   * @return the KnownFacesBreakdownImageIntegrity instance itself
   */
  public KnownFacesBreakdownImageIntegrity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.result, knownFacesBreakdownImageIntegrity.result)&&
        Objects.equals(this.additionalProperties, knownFacesBreakdownImageIntegrity.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KnownFacesBreakdownImageIntegrity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in KnownFacesBreakdownImageIntegrity is not found in the empty JSON string", KnownFacesBreakdownImageIntegrity.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KnownFacesBreakdownImageIntegrity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KnownFacesBreakdownImageIntegrity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KnownFacesBreakdownImageIntegrity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KnownFacesBreakdownImageIntegrity.class));

       return (TypeAdapter<T>) new TypeAdapter<KnownFacesBreakdownImageIntegrity>() {
           @Override
           public void write(JsonWriter out, KnownFacesBreakdownImageIntegrity value) throws IOException {
           ...
           @Override
           public KnownFacesBreakdownImageIntegrity read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             KnownFacesBreakdownImageIntegrity instance = thisAdapter.fromJsonTree(jsonObj);
