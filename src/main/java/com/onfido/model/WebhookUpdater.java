...
public class WebhookUpdater {
  ...
  public WebhookUpdater name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, webhookUpdater.enabled) &&
        ...
        Objects.equals(this.name, webhookUpdater.name) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookUpdater.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WebhookUpdater is not found in the empty JSON string", WebhookUpdater.openapiRequiredFields.toString()));
        }
      }
