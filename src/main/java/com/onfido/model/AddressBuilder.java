...
public class AddressBuilder {
  ...
  public boolean equals(Object o) {
    ...
    AddressBuilder addressBuilder = (AddressBuilder) o;
    return Objects.equals(this.flatNumber, addressBuilder.flatNumber) &&
        Objects.equals(this.buildingNumber, addressBuilder.buildingNumber) &&
        Objects.equals(this.buildingName, addressBuilder.buildingName) &&
        Objects.equals(this.street, addressBuilder.street) &&
        Objects.equals(this.subStreet, addressBuilder.subStreet) &&
        Objects.equals(this.town, addressBuilder.town) &&
  ...
  public String toString() {
    ...
    sb.append("class AddressBuilder {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddressBuilder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddressBuilder is not found in the empty JSON string", AddressBuilder.openapiRequiredFields.toString()));
        }
      }
