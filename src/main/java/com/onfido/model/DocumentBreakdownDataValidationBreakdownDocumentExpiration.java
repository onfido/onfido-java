...
public class DocumentBreakdownDataValidationBreakdownDocumentExpiration {
  ...
  public DocumentBreakdownDataValidationBreakdownDocumentExpiration result(@javax.annotation.Nullable String result) {
    this.result = result;
    return this;
  }
  ...
  public DocumentBreakdownDataValidationBreakdownDocumentExpiration properties(@javax.annotation.Nullable Object properties) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentBreakdownDataValidationBreakdownDocumentExpiration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentBreakdownDataValidationBreakdownDocumentExpiration is not found in the empty JSON string", DocumentBreakdownDataValidationBreakdownDocumentExpiration.openapiRequiredFields.toString()));
        }
      }
