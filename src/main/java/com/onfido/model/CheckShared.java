...
public class CheckShared {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("webhook_ids", "applicant_id", "applicant_provides_data", "tags", "redirect_uri", "privacy_notices_read_consent_given"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CheckShared is not found in the empty JSON string", CheckShared.openapiRequiredFields.toString()));
        }
      }
