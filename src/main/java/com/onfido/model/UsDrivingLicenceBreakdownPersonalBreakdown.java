...
public class UsDrivingLicenceBreakdownPersonalBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("first_name", "name_suffix", "height", "weight", "sex_code", "eye_color", "date_of_birth", "last_name", "middle_name", "first_name_fuzzy", "middle_name_fuzzy", "last_name_fuzzy", "middle_initial"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsDrivingLicenceBreakdownPersonalBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UsDrivingLicenceBreakdownPersonalBreakdown is not found in the empty JSON string", UsDrivingLicenceBreakdownPersonalBreakdown.openapiRequiredFields.toString()));
        }
      }
