...
public class FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties {
   ...
   * @return the FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties instance itself
   */
  public FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.score, facialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties.score) &&
        ...
        Objects.equals(this.additionalProperties, facialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(score, documentId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("score", "document_id"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties is not found in the empty JSON string", FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("document_id") != null && !jsonObj.get("document_id").isJsonNull()) && !jsonObj.get("document_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `document_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("document_id").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties>() {
           @Override
           public void write(JsonWriter out, FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties value) throws IOException {
           ...
           @Override
           public FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FacialSimilarityPhotoBreakdownFaceComparisonBreakdownFaceMatchProperties instance = thisAdapter.fromJsonTree(jsonObj);
