...
public class ProofOfAddressBreakdownDataComparisonBreakdown {
   ...
   * @return the ProofOfAddressBreakdownDataComparisonBreakdown instance itself
   */
  public ProofOfAddressBreakdownDataComparisonBreakdown putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, proofOfAddressBreakdownDataComparisonBreakdown.address) &&
        ...
        Objects.equals(this.additionalProperties, proofOfAddressBreakdownDataComparisonBreakdown.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, firstName, lastName, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("address", "first_name", "last_name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProofOfAddressBreakdownDataComparisonBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ProofOfAddressBreakdownDataComparisonBreakdown is not found in the empty JSON string", ProofOfAddressBreakdownDataComparisonBreakdown.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `address`
      if (jsonObj.get("address") != null && !jsonObj.get("address").isJsonNull()) {
        DocumentBreakdownDataComparisonBreakdownIssuingCountry.validateJsonElement(jsonObj.get("address"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProofOfAddressBreakdownDataComparisonBreakdown.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProofOfAddressBreakdownDataComparisonBreakdown' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProofOfAddressBreakdownDataComparisonBreakdown> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProofOfAddressBreakdownDataComparisonBreakdown.class));

       return (TypeAdapter<T>) new TypeAdapter<ProofOfAddressBreakdownDataComparisonBreakdown>() {
           @Override
           public void write(JsonWriter out, ProofOfAddressBreakdownDataComparisonBreakdown value) throws IOException {
           ...
           @Override
           public ProofOfAddressBreakdownDataComparisonBreakdown read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ProofOfAddressBreakdownDataComparisonBreakdown instance = thisAdapter.fromJsonTree(jsonObj);
