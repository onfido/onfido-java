...
public class DocumentReport {
   ...
   * @return the DocumentReport instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    DocumentReport documentReport = (DocumentReport) o;
    return Objects.equals(this.id, documentReport.id) &&
        Objects.equals(this.createdAt, documentReport.createdAt) &&
        Objects.equals(this.href, documentReport.href) &&
        Objects.equals(this.status, documentReport.status) &&
  ...
  public String toString() {
    ...
    sb.append("class DocumentReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentReport is not found in the empty JSON string", DocumentReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentReport.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentReport.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentReport>() {
           @Override
           public void write(JsonWriter out, DocumentReport value) throws IOException {
           ...
           @Override
           public DocumentReport read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DocumentReport instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of DocumentReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentReport
   * @throws IOException if the JSON string is invalid with respect to DocumentReport
   */
  public static DocumentReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentReport.class);
  }

  /**
   * Convert an instance of DocumentReport to an JSON string
   *
   * @return JSON string
   */
