 ...
 */
@JsonPropertyOrder({
  ProofOfAddressReport.JSON_PROPERTY_ID,
  ProofOfAddressReport.JSON_PROPERTY_CREATED_AT,
  ProofOfAddressReport.JSON_PROPERTY_HREF,
  ProofOfAddressReport.JSON_PROPERTY_STATUS,
  ProofOfAddressReport.JSON_PROPERTY_RESULT,
  ProofOfAddressReport.JSON_PROPERTY_SUB_RESULT,
  ProofOfAddressReport.JSON_PROPERTY_CHECK_ID,
  ProofOfAddressReport.JSON_PROPERTY_DOCUMENTS,
  ProofOfAddressReport.JSON_PROPERTY_NAME,
  ProofOfAddressReport.JSON_PROPERTY_BREAKDOWN,
  ProofOfAddressReport.JSON_PROPERTY_PROPERTIES
})
@JsonTypeName("proof_of_address_report")
...
public class ProofOfAddressReport {
  ...
  **/
  ...
  public ProofOfAddressReport name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this proof_of_address_report object is equal to o.
   */
  @Override
