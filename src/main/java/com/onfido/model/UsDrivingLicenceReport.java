...
public class UsDrivingLicenceReport {
  ...
  **/
  ...
  public UsDrivingLicenceReport documents(List<ReportDocument> documents) {
    this.documents = documents;
    return this;
  }

  public UsDrivingLicenceReport addDocumentsItem(ReportDocument documentsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, usDrivingLicenceReport.id) &&
        ...
        Objects.equals(this.documents, usDrivingLicenceReport.documents) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsDrivingLicenceReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsDrivingLicenceReport is not found in the empty JSON string", UsDrivingLicenceReport.openapiRequiredFields.toString()));
        }
      }
