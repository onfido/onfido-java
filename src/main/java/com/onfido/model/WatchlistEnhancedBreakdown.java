...
public class WatchlistEnhancedBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("politically_exposed_person", "sanction", "adverse_media", "monitored_lists"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistEnhancedBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WatchlistEnhancedBreakdown is not found in the empty JSON string", WatchlistEnhancedBreakdown.openapiRequiredFields.toString()));
        }
      }
