...
public class IdPhoto {
  ...
  public IdPhoto id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public IdPhoto createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public IdPhoto href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public IdPhoto downloadHref(@javax.annotation.Nullable String downloadHref) {
  ...
  public IdPhoto fileName(@javax.annotation.Nullable String fileName) {
  ...
  public IdPhoto fileType(@javax.annotation.Nullable String fileType) {
  ...
  public IdPhoto fileSize(@javax.annotation.Nullable Integer fileSize) {
   ...
   * @return the IdPhoto instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to IdPhoto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdPhoto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IdPhoto is not found in the empty JSON string", IdPhoto.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IdPhoto.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IdPhoto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IdPhoto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IdPhoto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IdPhoto.class));

       return (TypeAdapter<T>) new TypeAdapter<IdPhoto>() {
           @Override
           public void write(JsonWriter out, IdPhoto value) throws IOException {
           ...
           @Override
           public IdPhoto read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             IdPhoto instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of IdPhoto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IdPhoto
   * @throws IOException if the JSON string is invalid with respect to IdPhoto
   */
  public static IdPhoto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IdPhoto.class);
  }

  /**
   * Convert an instance of IdPhoto to an JSON string
   *
   * @return JSON string
   */
