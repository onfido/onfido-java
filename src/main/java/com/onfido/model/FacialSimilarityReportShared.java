...
public class FacialSimilarityReportShared {
   ...
   * @return the FacialSimilarityReportShared instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.documents, facialSimilarityReportShared.documents) &&
        ...
        Objects.equals(this.additionalProperties, facialSimilarityReportShared.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FacialSimilarityReportShared
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FacialSimilarityReportShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FacialSimilarityReportShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FacialSimilarityReportShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FacialSimilarityReportShared.class));

       return (TypeAdapter<T>) new TypeAdapter<FacialSimilarityReportShared>() {
           @Override
           public void write(JsonWriter out, FacialSimilarityReportShared value) throws IOException {
           ...
           @Override
           public FacialSimilarityReportShared read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FacialSimilarityReportShared instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FacialSimilarityReportShared given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FacialSimilarityReportShared
   * @throws IOException if the JSON string is invalid with respect to FacialSimilarityReportShared
   */
  public static FacialSimilarityReportShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FacialSimilarityReportShared.class);
  }

  /**
   * Convert an instance of FacialSimilarityReportShared to an JSON string
   *
   * @return JSON string
   */
