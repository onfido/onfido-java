...
public class Error1 {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(documentId, error, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("document_id", "error"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        ErrorProperties1.validateJsonElement(jsonObj.get("error"));
      }
  }
