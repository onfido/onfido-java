...
public class KnownFacesBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("previously_seen_faces", "image_integrity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KnownFacesBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in KnownFacesBreakdown is not found in the empty JSON string", KnownFacesBreakdown.openapiRequiredFields.toString()));
        }
      }
