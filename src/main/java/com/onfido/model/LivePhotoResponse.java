 ...
 */
@JsonPropertyOrder({
  LivePhotoResponse.JSON_PROPERTY_ID,
  LivePhotoResponse.JSON_PROPERTY_CREATED_AT,
  LivePhotoResponse.JSON_PROPERTY_HREF,
  LivePhotoResponse.JSON_PROPERTY_DOWNLOAD_HREF,
  LivePhotoResponse.JSON_PROPERTY_FILE_NAME,
  LivePhotoResponse.JSON_PROPERTY_FILE_TYPE,
  LivePhotoResponse.JSON_PROPERTY_FILE_SIZE
})
@JsonTypeName("live_photo_response")
...
public class LivePhotoResponse {
  ...
  **/
  ...
  /**
   * Return true if this live_photo_response object is equal to o.
   */
  @Override
