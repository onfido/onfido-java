...
public class WebhookEventPayload {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("resource_type", "action", "object", "resource"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("resource_type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookEventPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WebhookEventPayload is not found in the empty JSON string", WebhookEventPayload.openapiRequiredFields.toString()));
        }
      }
