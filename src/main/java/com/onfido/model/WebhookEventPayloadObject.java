  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookEventPayloadObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookEventPayloadObject is not found in the empty JSON string", WebhookEventPayloadObject.openapiRequiredFields.toString()));
        }
      }
