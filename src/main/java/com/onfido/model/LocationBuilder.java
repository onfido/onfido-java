...
public class LocationBuilder {
   ...
   * @return the LocationBuilder instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to LocationBuilder
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LocationBuilder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in LocationBuilder is not found in the empty JSON string", LocationBuilder.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationBuilder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationBuilder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationBuilder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationBuilder.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationBuilder>() {
           @Override
           public void write(JsonWriter out, LocationBuilder value) throws IOException {
           ...
           @Override
           public LocationBuilder read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             LocationBuilder instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of LocationBuilder given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LocationBuilder
   * @throws IOException if the JSON string is invalid with respect to LocationBuilder
   */
  public static LocationBuilder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationBuilder.class);
  }

  /**
   * Convert an instance of LocationBuilder to an JSON string
   *
   * @return JSON string
   */
