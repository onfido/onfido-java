 ...
 */
@JsonPropertyOrder({
  WatchlistStandardProperties.JSON_PROPERTY_RECORDS
})
@JsonTypeName("watchlist_standard_properties")
...
public class WatchlistStandardProperties {
  ...
  **/
  ...
  /**
   * Return true if this watchlist_standard_properties object is equal to o.
   */
  @Override
