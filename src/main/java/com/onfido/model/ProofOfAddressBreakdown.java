...
public class ProofOfAddressBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("data_comparison", "document_classification", "image_integrity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProofOfAddressBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ProofOfAddressBreakdown is not found in the empty JSON string", ProofOfAddressBreakdown.openapiRequiredFields.toString()));
        }
      }
