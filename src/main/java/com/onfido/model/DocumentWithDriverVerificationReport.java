...
import com.onfido.model.DocumentWithDriverVerificationReportAllOfProperties;
...
public class DocumentWithDriverVerificationReport {
  ...
  public DocumentWithDriverVerificationReport addDocumentsItem(ReportDocument documentsItem) {
   ...
   */
  @javax.annotation.Nullable
  public DocumentWithDriverVerificationReportAllOfProperties getProperties() {
    return properties;
  }
   ...
   * @return the DocumentWithDriverVerificationReport instance itself
   */
  public DocumentWithDriverVerificationReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DocumentWithDriverVerificationReport documentWithDriverVerificationReport = (DocumentWithDriverVerificationReport) o;
    return Objects.equals(this.id, documentWithDriverVerificationReport.id) &&
        Objects.equals(this.createdAt, documentWithDriverVerificationReport.createdAt) &&
        Objects.equals(this.href, documentWithDriverVerificationReport.href) &&
        Objects.equals(this.status, documentWithDriverVerificationReport.status) &&
        Objects.equals(this.result, documentWithDriverVerificationReport.result) &&
        Objects.equals(this.subResult, documentWithDriverVerificationReport.subResult) &&
        Objects.equals(this.checkId, documentWithDriverVerificationReport.checkId) &&
        Objects.equals(this.name, documentWithDriverVerificationReport.name) &&
        Objects.equals(this.documents, documentWithDriverVerificationReport.documents) &&
        Objects.equals(this.breakdown, documentWithDriverVerificationReport.breakdown) &&
        Objects.equals(this.properties, documentWithDriverVerificationReport.properties)&&
        Objects.equals(this.additionalProperties, documentWithDriverVerificationReport.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentWithDriverVerificationReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentWithDriverVerificationReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentWithDriverVerificationReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentWithDriverVerificationReport is not found in the empty JSON string", DocumentWithDriverVerificationReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentWithDriverVerificationReport.openapiRequiredFields) {
      ...
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        DocumentWithDriverVerificationReportAllOfProperties.validateJsonElement(jsonObj.get("properties"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentWithDriverVerificationReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentWithDriverVerificationReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentWithDriverVerificationReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentWithDriverVerificationReport.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentWithDriverVerificationReport>() {
           @Override
           public void write(JsonWriter out, DocumentWithDriverVerificationReport value) throws IOException {
           ...
           @Override
           public DocumentWithDriverVerificationReport read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DocumentWithDriverVerificationReport instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of DocumentWithDriverVerificationReport
   * @throws IOException if the JSON string is invalid with respect to DocumentWithDriverVerificationReport
   */
  public static DocumentWithDriverVerificationReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentWithDriverVerificationReport.class);
  }

  /**
   * Convert an instance of DocumentWithDriverVerificationReport to an JSON string
   *
   * @return JSON string
   */
