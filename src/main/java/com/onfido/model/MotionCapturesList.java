...
public class MotionCapturesList {
  ...
  **/
   ...
   * @return the MotionCapturesList instance itself
   */
  public MotionCapturesList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.motionCaptures, motionCapturesList.motionCaptures)&&
        Objects.equals(this.additionalProperties, motionCapturesList.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(motionCaptures, additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `motion_captures` (array)
      for (int i = 0; i < jsonArraymotionCaptures.size(); i++) {
        MotionCapture.validateJsonElement(jsonArraymotionCaptures.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MotionCapturesList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MotionCapturesList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MotionCapturesList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MotionCapturesList.class));

       return (TypeAdapter<T>) new TypeAdapter<MotionCapturesList>() {
           @Override
           public void write(JsonWriter out, MotionCapturesList value) throws IOException {
           ...
           @Override
           public MotionCapturesList read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MotionCapturesList instance = thisAdapter.fromJsonTree(jsonObj);
