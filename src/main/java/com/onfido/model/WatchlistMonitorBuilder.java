...
public class WatchlistMonitorBuilder {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("applicant_id", "report_name", "tags"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("applicant_id", "report_name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistMonitorBuilder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WatchlistMonitorBuilder is not found in the empty JSON string", WatchlistMonitorBuilder.openapiRequiredFields.toString()));
        }
      }
