...
import com.onfido.model.UsDrivingLicenceBreakdown;
...
public class UsDrivingLicenceReport {
   ...
   */
  @javax.annotation.Nullable
  public UsDrivingLicenceBreakdown getBreakdown() {
    return breakdown;
  }
   ...
   * @return the UsDrivingLicenceReport instance itself
   */
  public UsDrivingLicenceReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UsDrivingLicenceReport usDrivingLicenceReport = (UsDrivingLicenceReport) o;
    return Objects.equals(this.id, usDrivingLicenceReport.id) &&
        Objects.equals(this.createdAt, usDrivingLicenceReport.createdAt) &&
        Objects.equals(this.href, usDrivingLicenceReport.href) &&
        Objects.equals(this.status, usDrivingLicenceReport.status) &&
        Objects.equals(this.result, usDrivingLicenceReport.result) &&
        Objects.equals(this.subResult, usDrivingLicenceReport.subResult) &&
        Objects.equals(this.checkId, usDrivingLicenceReport.checkId) &&
        Objects.equals(this.name, usDrivingLicenceReport.name) &&
        Objects.equals(this.breakdown, usDrivingLicenceReport.breakdown) &&
        Objects.equals(this.properties, usDrivingLicenceReport.properties)&&
        Objects.equals(this.additionalProperties, usDrivingLicenceReport.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsDrivingLicenceReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UsDrivingLicenceReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsDrivingLicenceReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UsDrivingLicenceReport is not found in the empty JSON string", UsDrivingLicenceReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UsDrivingLicenceReport.openapiRequiredFields) {
      ...
      if (jsonObj.get("breakdown") != null && !jsonObj.get("breakdown").isJsonNull()) {
        UsDrivingLicenceBreakdown.validateJsonElement(jsonObj.get("breakdown"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsDrivingLicenceReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsDrivingLicenceReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsDrivingLicenceReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsDrivingLicenceReport.class));

       return (TypeAdapter<T>) new TypeAdapter<UsDrivingLicenceReport>() {
           @Override
           public void write(JsonWriter out, UsDrivingLicenceReport value) throws IOException {
           ...
           @Override
           public UsDrivingLicenceReport read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UsDrivingLicenceReport instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of UsDrivingLicenceReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UsDrivingLicenceReport
   * @throws IOException if the JSON string is invalid with respect to UsDrivingLicenceReport
   */
  public static UsDrivingLicenceReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsDrivingLicenceReport.class);
  }

  /**
   * Convert an instance of UsDrivingLicenceReport to an JSON string
   *
   * @return JSON string
   */
