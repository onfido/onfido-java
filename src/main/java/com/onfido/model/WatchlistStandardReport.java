...
public class WatchlistStandardReport {
  ...
  public WatchlistStandardReport id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public WatchlistStandardReport createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public WatchlistStandardReport href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public WatchlistStandardReport status(@javax.annotation.Nullable ReportStatus status) {
    this.status = status;
    return this;
  }
  ...
  public WatchlistStandardReport result(@javax.annotation.Nullable ReportResult result) {
    this.result = result;
    return this;
  }
  ...
  public WatchlistStandardReport subResult(@javax.annotation.Nullable ReportSubResult subResult) {
  ...
  public WatchlistStandardReport checkId(@javax.annotation.Nullable UUID checkId) {
  ...
  public WatchlistStandardReport name(@javax.annotation.Nonnull ReportName name) {
    this.name = name;
    return this;
  }
  ...
  public WatchlistStandardReport breakdown(@javax.annotation.Nullable WatchlistStandardBreakdown breakdown) {
  ...
  public WatchlistStandardReport properties(@javax.annotation.Nullable WatchlistStandardProperties properties) {
   ...
   * @return the WatchlistStandardReport instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to WatchlistStandardReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistStandardReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WatchlistStandardReport is not found in the empty JSON string", WatchlistStandardReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WatchlistStandardReport.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WatchlistStandardReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WatchlistStandardReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WatchlistStandardReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WatchlistStandardReport.class));

       return (TypeAdapter<T>) new TypeAdapter<WatchlistStandardReport>() {
           @Override
           public void write(JsonWriter out, WatchlistStandardReport value) throws IOException {
           ...
           @Override
           public WatchlistStandardReport read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             WatchlistStandardReport instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of WatchlistStandardReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WatchlistStandardReport
   * @throws IOException if the JSON string is invalid with respect to WatchlistStandardReport
   */
  public static WatchlistStandardReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WatchlistStandardReport.class);
  }

  /**
   * Convert an instance of WatchlistStandardReport to an JSON string
   *
   * @return JSON string
   */
