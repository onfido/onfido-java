 ...
 */
@JsonPropertyOrder({
  DocumentBreakdownDataValidationBreakdownDocumentExpiration.JSON_PROPERTY_RESULT,
  DocumentBreakdownDataValidationBreakdownDocumentExpiration.JSON_PROPERTY_PROPERTIES
})
@JsonTypeName("document_breakdown_data_validation_breakdown_document_expiration")
...
public class DocumentBreakdownDataValidationBreakdownDocumentExpiration {
  ...
  **/
  ...
  /**
   * Return true if this document_breakdown_data_validation_breakdown_document_expiration object is equal to o.
   */
  @Override
