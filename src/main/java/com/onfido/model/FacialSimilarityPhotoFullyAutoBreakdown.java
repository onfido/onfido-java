...
public class FacialSimilarityPhotoFullyAutoBreakdown {
  ...
  public FacialSimilarityPhotoFullyAutoBreakdown faceComparison(@javax.annotation.Nullable FacialSimilarityPhotoBreakdownFaceComparison faceComparison) {
  ...
  public void setFaceComparison(@javax.annotation.Nullable FacialSimilarityPhotoBreakdownFaceComparison faceComparison) {
    this.faceComparison = faceComparison;
  }


  public FacialSimilarityPhotoFullyAutoBreakdown imageIntegrity(@javax.annotation.Nullable FacialSimilarityPhotoFullyAutoBreakdownImageIntegrity imageIntegrity) {
  ...
  public void setImageIntegrity(@javax.annotation.Nullable FacialSimilarityPhotoFullyAutoBreakdownImageIntegrity imageIntegrity) {
    this.imageIntegrity = imageIntegrity;
  }


  public FacialSimilarityPhotoFullyAutoBreakdown visualAuthenticity(@javax.annotation.Nullable FacialSimilarityPhotoBreakdownVisualAuthenticity visualAuthenticity) {
  ...
  public void setVisualAuthenticity(@javax.annotation.Nullable FacialSimilarityPhotoBreakdownVisualAuthenticity visualAuthenticity) {
    this.visualAuthenticity = visualAuthenticity;
  }
   ...
   * @return the FacialSimilarityPhotoFullyAutoBreakdown instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.faceComparison, facialSimilarityPhotoFullyAutoBreakdown.faceComparison) &&
        ...
        Objects.equals(this.additionalProperties, facialSimilarityPhotoFullyAutoBreakdown.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FacialSimilarityPhotoFullyAutoBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in FacialSimilarityPhotoFullyAutoBreakdown is not found in the empty JSON string", FacialSimilarityPhotoFullyAutoBreakdown.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("image_integrity") != null && !jsonObj.get("image_integrity").isJsonNull()) {
        FacialSimilarityPhotoFullyAutoBreakdownImageIntegrity.validateJsonElement(jsonObj.get("image_integrity"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FacialSimilarityPhotoFullyAutoBreakdown.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FacialSimilarityPhotoFullyAutoBreakdown' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FacialSimilarityPhotoFullyAutoBreakdown> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FacialSimilarityPhotoFullyAutoBreakdown.class));

       return (TypeAdapter<T>) new TypeAdapter<FacialSimilarityPhotoFullyAutoBreakdown>() {
           @Override
           public void write(JsonWriter out, FacialSimilarityPhotoFullyAutoBreakdown value) throws IOException {
           ...
           @Override
           public FacialSimilarityPhotoFullyAutoBreakdown read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FacialSimilarityPhotoFullyAutoBreakdown instance = thisAdapter.fromJsonTree(jsonObj);
