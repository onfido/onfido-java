...
public class IdPhotoTest extends TestBase {
  ...
  public void uploadIdPhotoTest() throws Exception {
    ...
    Assertions.assertNull(idPhoto.getAdditionalProperties());
  }
  ...
  public void listIdPhotosTest() throws Exception {
    ...
    Assertions.assertNull(idPhotos.get(0).getAdditionalProperties());
    Assertions.assertNull(idPhotos.get(1).getAdditionalProperties());
  }
}
