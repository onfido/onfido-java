...
public class DocumentPropertiesDrivingLicenceInformationItem {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("category", "obtainment_date", "expiry_date", "codes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentPropertiesDrivingLicenceInformationItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentPropertiesDrivingLicenceInformationItem is not found in the empty JSON string", DocumentPropertiesDrivingLicenceInformationItem.openapiRequiredFields.toString()));
        }
      }
