...
public class PasskeyUpdater {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PasskeyUpdater.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PasskeyUpdater is not found in the empty JSON string", PasskeyUpdater.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<PasskeyUpdater> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PasskeyUpdater.class));

       return (TypeAdapter<T>) new TypeAdapter<PasskeyUpdater>() {
           @Override
