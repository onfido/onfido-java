...
public class ExtractionDocumentClassification {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issuing_country", "document_type", "issuing_state", "subtype", "version"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExtractionDocumentClassification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ExtractionDocumentClassification is not found in the empty JSON string", ExtractionDocumentClassification.openapiRequiredFields.toString()));
        }
      }
