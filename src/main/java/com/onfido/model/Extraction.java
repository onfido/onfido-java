...
public class Extraction {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("document_id", "document_classification", "extracted_data"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Extraction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Extraction is not found in the empty JSON string", Extraction.openapiRequiredFields.toString()));
        }
      }
