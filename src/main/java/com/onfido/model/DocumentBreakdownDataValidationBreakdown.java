...
public class DocumentBreakdownDataValidationBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("gender", "date_of_birth", "document_numbers", "document_expiration", "expiry_date", "mrz", "barcode"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentBreakdownDataValidationBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentBreakdownDataValidationBreakdown is not found in the empty JSON string", DocumentBreakdownDataValidationBreakdown.openapiRequiredFields.toString()));
        }
      }
