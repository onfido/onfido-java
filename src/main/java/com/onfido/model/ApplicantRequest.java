...
public class ApplicantRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("consents", "address", "location"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicantRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ApplicantRequest is not found in the empty JSON string", ApplicantRequest.openapiRequiredFields.toString()));
        }
      }
