...
public class ProofOfAddressProperties {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("address", "document_type", "first_names", "last_names", "issue_date", "issuer", "summary_period_start", "summary_period_end"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProofOfAddressProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ProofOfAddressProperties is not found in the empty JSON string", ProofOfAddressProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("first_names") != null && !jsonObj.get("first_names").isJsonNull()) && !jsonObj.get("first_names").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `first_names` to be a primitive type in the JSON string but got `%s`", jsonObj.get("first_names").toString()));
      }
      if ((jsonObj.get("last_names") != null && !jsonObj.get("last_names").isJsonNull()) && !jsonObj.get("last_names").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `last_names` to be a primitive type in the JSON string but got `%s`", jsonObj.get("last_names").toString()));
      }
