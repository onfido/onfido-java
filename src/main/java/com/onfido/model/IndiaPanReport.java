 ...
 */
@JsonPropertyOrder({
  IndiaPanReport.JSON_PROPERTY_ID,
  IndiaPanReport.JSON_PROPERTY_CREATED_AT,
  IndiaPanReport.JSON_PROPERTY_HREF,
  IndiaPanReport.JSON_PROPERTY_STATUS,
  IndiaPanReport.JSON_PROPERTY_RESULT,
  IndiaPanReport.JSON_PROPERTY_SUB_RESULT,
  IndiaPanReport.JSON_PROPERTY_CHECK_ID,
  IndiaPanReport.JSON_PROPERTY_DOCUMENTS,
  IndiaPanReport.JSON_PROPERTY_NAME,
  IndiaPanReport.JSON_PROPERTY_BREAKDOWN,
  IndiaPanReport.JSON_PROPERTY_PROPERTIES
})
@JsonTypeName("india_pan_report")
...
public class IndiaPanReport {
  ...
  **/
  ...
  public IndiaPanReport name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this india_pan_report object is equal to o.
   */
  @Override
