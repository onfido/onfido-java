...
public class WatchlistMonitorResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created_at", "deleted_at", "is_sandbox"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistMonitorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WatchlistMonitorResponse is not found in the empty JSON string", WatchlistMonitorResponse.openapiRequiredFields.toString()));
        }
      }
