 ...
 */
@JsonPropertyOrder({
  DeviceIntelligenceBreakdownBreakdown.JSON_PROPERTY_DEVICE
})
@JsonTypeName("device_intelligence_breakdown_breakdown")
...
public class DeviceIntelligenceBreakdownBreakdown {
  ...
  **/
  ...
  /**
   * Return true if this device_intelligence_breakdown_breakdown object is equal to o.
   */
  @Override
