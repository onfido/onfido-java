  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FacialSimilarityMotionBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in FacialSimilarityMotionBreakdown is not found in the empty JSON string", FacialSimilarityMotionBreakdown.openapiRequiredFields.toString()));
        }
      }
