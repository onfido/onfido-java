...
public class DocumentsList {
   ...
   * @return the DocumentsList instance itself
   */
  public DocumentsList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.documents, documentsList.documents)&&
        Objects.equals(this.additionalProperties, documentsList.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentsList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentsList is not found in the empty JSON string", DocumentsList.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentsList.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentsList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentsList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentsList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentsList.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentsList>() {
           @Override
           public void write(JsonWriter out, DocumentsList value) throws IOException {
           ...
           @Override
           public DocumentsList read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DocumentsList instance = thisAdapter.fromJsonTree(jsonObj);
