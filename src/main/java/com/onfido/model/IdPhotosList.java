...
public class IdPhotosList {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(idPhotos, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id_photos"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id_photos"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdPhotosList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IdPhotosList is not found in the empty JSON string", IdPhotosList.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the required field `id_photos` (array)
      for (int i = 0; i < jsonArrayidPhotos.size(); i++) {
        IdPhoto.validateJsonElement(jsonArrayidPhotos.get(i));
      };
  }
