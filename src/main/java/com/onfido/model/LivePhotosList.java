...
public class LivePhotosList {
  ...
  public LivePhotosList livePhotos(@javax.annotation.Nonnull List<LivePhoto> livePhotos) {
  ...
  public void setLivePhotos(@javax.annotation.Nonnull List<LivePhoto> livePhotos) {
    this.livePhotos = livePhotos;
  }
   ...
   * @return the LivePhotosList instance itself
   */
  public LivePhotosList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.livePhotos, livePhotosList.livePhotos)&&
        Objects.equals(this.additionalProperties, livePhotosList.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(livePhotos, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("live_photos"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("live_photos"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LivePhotosList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in LivePhotosList is not found in the empty JSON string", LivePhotosList.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LivePhotosList.openapiRequiredFields) {
      ...
      // validate the required field `live_photos` (array)
      for (int i = 0; i < jsonArraylivePhotos.size(); i++) {
        LivePhoto.validateJsonElement(jsonArraylivePhotos.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LivePhotosList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LivePhotosList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LivePhotosList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LivePhotosList.class));

       return (TypeAdapter<T>) new TypeAdapter<LivePhotosList>() {
           @Override
           public void write(JsonWriter out, LivePhotosList value) throws IOException {
           ...
           @Override
           public LivePhotosList read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             LivePhotosList instance = thisAdapter.fromJsonTree(jsonObj);
