 ...
 */
@JsonPropertyOrder({
  WatchlistAmlProperties.JSON_PROPERTY_RECORDS
})
@JsonTypeName("watchlist_aml_properties")
...
public class WatchlistAmlProperties {
  ...
  public WatchlistAmlProperties addRecordsItem(String recordsItem) {
  ...
  **/
  ...
  /**
   * Return true if this watchlist_aml_properties object is equal to o.
   */
  @Override
