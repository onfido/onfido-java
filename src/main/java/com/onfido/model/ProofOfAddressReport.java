...
import com.onfido.model.ProofOfAddressBreakdown;
import com.onfido.model.ProofOfAddressProperties;
...
public class ProofOfAddressReport {
   ...
   */
  @javax.annotation.Nullable
  public ProofOfAddressBreakdown getBreakdown() {
    return breakdown;
  }
   ...
   */
  @javax.annotation.Nullable
  public ProofOfAddressProperties getProperties() {
    return properties;
  }
   ...
   * @return the ProofOfAddressReport instance itself
   */
  public ProofOfAddressReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProofOfAddressReport proofOfAddressReport = (ProofOfAddressReport) o;
    return Objects.equals(this.id, proofOfAddressReport.id) &&
        Objects.equals(this.createdAt, proofOfAddressReport.createdAt) &&
        Objects.equals(this.href, proofOfAddressReport.href) &&
        Objects.equals(this.status, proofOfAddressReport.status) &&
        Objects.equals(this.result, proofOfAddressReport.result) &&
        Objects.equals(this.subResult, proofOfAddressReport.subResult) &&
        Objects.equals(this.checkId, proofOfAddressReport.checkId) &&
        Objects.equals(this.name, proofOfAddressReport.name) &&
        Objects.equals(this.breakdown, proofOfAddressReport.breakdown) &&
        Objects.equals(this.properties, proofOfAddressReport.properties)&&
        Objects.equals(this.additionalProperties, proofOfAddressReport.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProofOfAddressReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProofOfAddressReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProofOfAddressReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ProofOfAddressReport is not found in the empty JSON string", ProofOfAddressReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProofOfAddressReport.openapiRequiredFields) {
      ...
      if (jsonObj.get("breakdown") != null && !jsonObj.get("breakdown").isJsonNull()) {
        ProofOfAddressBreakdown.validateJsonElement(jsonObj.get("breakdown"));
      }
      // validate the optional field `properties`
      if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
        ProofOfAddressProperties.validateJsonElement(jsonObj.get("properties"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProofOfAddressReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProofOfAddressReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProofOfAddressReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProofOfAddressReport.class));

       return (TypeAdapter<T>) new TypeAdapter<ProofOfAddressReport>() {
           @Override
           public void write(JsonWriter out, ProofOfAddressReport value) throws IOException {
           ...
           @Override
           public ProofOfAddressReport read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ProofOfAddressReport instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ProofOfAddressReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProofOfAddressReport
   * @throws IOException if the JSON string is invalid with respect to ProofOfAddressReport
   */
  public static ProofOfAddressReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProofOfAddressReport.class);
  }

  /**
   * Convert an instance of ProofOfAddressReport to an JSON string
   *
   * @return JSON string
   */
