...
public class WatchlistStandardBreakdown {
   ...
   * @return the WatchlistStandardBreakdown instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sanction, watchlistStandardBreakdown.sanction) &&
        ...
        Objects.equals(this.additionalProperties, watchlistStandardBreakdown.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sanction, politicallyExposedPerson, legalAndRegulatoryWarnings, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sanction", "politically_exposed_person", "legal_and_regulatory_warnings"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistStandardBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WatchlistStandardBreakdown is not found in the empty JSON string", WatchlistStandardBreakdown.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WatchlistStandardBreakdown.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WatchlistStandardBreakdown' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WatchlistStandardBreakdown> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WatchlistStandardBreakdown.class));

       return (TypeAdapter<T>) new TypeAdapter<WatchlistStandardBreakdown>() {
           @Override
           public void write(JsonWriter out, WatchlistStandardBreakdown value) throws IOException {
           ...
           @Override
           public WatchlistStandardBreakdown read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             WatchlistStandardBreakdown instance = thisAdapter.fromJsonTree(jsonObj);
