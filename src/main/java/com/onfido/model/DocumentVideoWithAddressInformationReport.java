...
public class DocumentVideoWithAddressInformationReport {
  ...
  public DocumentVideoWithAddressInformationReport addDocumentsItem(ReportDocument documentsItem) {
   ...
   * @return the DocumentVideoWithAddressInformationReport instance itself
   */
  public DocumentVideoWithAddressInformationReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DocumentVideoWithAddressInformationReport documentVideoWithAddressInformationReport = (DocumentVideoWithAddressInformationReport) o;
    return Objects.equals(this.id, documentVideoWithAddressInformationReport.id) &&
        Objects.equals(this.createdAt, documentVideoWithAddressInformationReport.createdAt) &&
        Objects.equals(this.href, documentVideoWithAddressInformationReport.href) &&
        Objects.equals(this.status, documentVideoWithAddressInformationReport.status) &&
        Objects.equals(this.result, documentVideoWithAddressInformationReport.result) &&
        Objects.equals(this.subResult, documentVideoWithAddressInformationReport.subResult) &&
        Objects.equals(this.checkId, documentVideoWithAddressInformationReport.checkId) &&
        Objects.equals(this.name, documentVideoWithAddressInformationReport.name) &&
        Objects.equals(this.documents, documentVideoWithAddressInformationReport.documents) &&
        Objects.equals(this.breakdown, documentVideoWithAddressInformationReport.breakdown) &&
        Objects.equals(this.properties, documentVideoWithAddressInformationReport.properties)&&
        Objects.equals(this.additionalProperties, documentVideoWithAddressInformationReport.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentVideoWithAddressInformationReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentVideoWithAddressInformationReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentVideoWithAddressInformationReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentVideoWithAddressInformationReport is not found in the empty JSON string", DocumentVideoWithAddressInformationReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentVideoWithAddressInformationReport.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentVideoWithAddressInformationReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentVideoWithAddressInformationReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentVideoWithAddressInformationReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentVideoWithAddressInformationReport.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentVideoWithAddressInformationReport>() {
           @Override
           public void write(JsonWriter out, DocumentVideoWithAddressInformationReport value) throws IOException {
           ...
           @Override
           public DocumentVideoWithAddressInformationReport read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DocumentVideoWithAddressInformationReport instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of DocumentVideoWithAddressInformationReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentVideoWithAddressInformationReport
   * @throws IOException if the JSON string is invalid with respect to DocumentVideoWithAddressInformationReport
   */
  public static DocumentVideoWithAddressInformationReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentVideoWithAddressInformationReport.class);
  }

  /**
   * Convert an instance of DocumentVideoWithAddressInformationReport to an JSON string
   *
   * @return JSON string
   */
