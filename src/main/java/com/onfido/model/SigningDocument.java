...
public class SigningDocument {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("applicant_id", "id", "created_at", "href", "download_href", "file_type", "file_name", "file_size"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to SigningDocument
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SigningDocument.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SigningDocument is not found in the empty JSON string", SigningDocument.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SigningDocument.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SigningDocument.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SigningDocument' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SigningDocument> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SigningDocument.class));

       return (TypeAdapter<T>) new TypeAdapter<SigningDocument>() {
           @Override
           public void write(JsonWriter out, SigningDocument value) throws IOException {
           ...
           @Override
           public SigningDocument read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SigningDocument instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SigningDocument given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SigningDocument
   * @throws IOException if the JSON string is invalid with respect to SigningDocument
   */
  public static SigningDocument fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SigningDocument.class);
  }

  /**
   * Convert an instance of SigningDocument to an JSON string
   *
   * @return JSON string
   */
