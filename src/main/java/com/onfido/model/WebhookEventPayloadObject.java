...
public class WebhookEventPayloadObject {
   ...
   * @return the WebhookEventPayloadObject instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "status", "started_at_iso8601", "completed_at_iso8601", "href"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookEventPayloadObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WebhookEventPayloadObject is not found in the empty JSON string", WebhookEventPayloadObject.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookEventPayloadObject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookEventPayloadObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookEventPayloadObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookEventPayloadObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookEventPayloadObject.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookEventPayloadObject>() {
           @Override
           public void write(JsonWriter out, WebhookEventPayloadObject value) throws IOException {
           ...
           @Override
           public WebhookEventPayloadObject read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             WebhookEventPayloadObject instance = thisAdapter.fromJsonTree(jsonObj);
