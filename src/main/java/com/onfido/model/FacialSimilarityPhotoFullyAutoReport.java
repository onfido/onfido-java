...
public class FacialSimilarityPhotoFullyAutoReport {
  ...
  public FacialSimilarityPhotoFullyAutoReport id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public FacialSimilarityPhotoFullyAutoReport createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public FacialSimilarityPhotoFullyAutoReport href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public FacialSimilarityPhotoFullyAutoReport status(@javax.annotation.Nullable ReportStatus status) {
    this.status = status;
    return this;
  }
  ...
  public FacialSimilarityPhotoFullyAutoReport result(@javax.annotation.Nullable ReportResult result) {
    this.result = result;
    return this;
  }
  ...
  public FacialSimilarityPhotoFullyAutoReport subResult(@javax.annotation.Nullable ReportSubResult subResult) {
  ...
  public FacialSimilarityPhotoFullyAutoReport checkId(@javax.annotation.Nullable UUID checkId) {
  ...
  public FacialSimilarityPhotoFullyAutoReport name(@javax.annotation.Nonnull ReportName name) {
    this.name = name;
    return this;
  }
  ...
  public FacialSimilarityPhotoFullyAutoReport documents(@javax.annotation.Nullable List<ReportDocument> documents) {
    this.documents = documents;
    return this;
  }

  public FacialSimilarityPhotoFullyAutoReport addDocumentsItem(ReportDocument documentsItem) {
  ...
  public FacialSimilarityPhotoFullyAutoReport livePhotos(@javax.annotation.Nullable List<FacialSimilarityReportMedia> livePhotos) {
  ...
  public FacialSimilarityPhotoFullyAutoReport liveVideos(@javax.annotation.Nullable List<FacialSimilarityReportMedia> liveVideos) {
  ...
  public FacialSimilarityPhotoFullyAutoReport motionCaptures(@javax.annotation.Nullable List<FacialSimilarityReportMedia> motionCaptures) {
  ...
  public FacialSimilarityPhotoFullyAutoReport idPhotos(@javax.annotation.Nullable List<FacialSimilarityReportMedia> idPhotos) {
  ...
  public FacialSimilarityPhotoFullyAutoReport breakdown(@javax.annotation.Nullable FacialSimilarityPhotoFullyAutoBreakdown breakdown) {
   ...
   */
  @javax.annotation.Nullable
  public FacialSimilarityPhotoFullyAutoBreakdown getBreakdown() {
    return breakdown;
  }

  public void setBreakdown(@javax.annotation.Nullable FacialSimilarityPhotoFullyAutoBreakdown breakdown) {
    this.breakdown = breakdown;
  }


  public FacialSimilarityPhotoFullyAutoReport properties(@javax.annotation.Nullable FacialSimilarityPhotoFullyAutoProperties properties) {
  ...
  public void setProperties(@javax.annotation.Nullable FacialSimilarityPhotoFullyAutoProperties properties) {
    this.properties = properties;
  }
   ...
   * @return the FacialSimilarityPhotoFullyAutoReport instance itself
   */
  public FacialSimilarityPhotoFullyAutoReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FacialSimilarityPhotoFullyAutoReport facialSimilarityPhotoFullyAutoReport = (FacialSimilarityPhotoFullyAutoReport) o;
    return Objects.equals(this.id, facialSimilarityPhotoFullyAutoReport.id) &&
        Objects.equals(this.createdAt, facialSimilarityPhotoFullyAutoReport.createdAt) &&
        Objects.equals(this.href, facialSimilarityPhotoFullyAutoReport.href) &&
        Objects.equals(this.status, facialSimilarityPhotoFullyAutoReport.status) &&
        Objects.equals(this.result, facialSimilarityPhotoFullyAutoReport.result) &&
        Objects.equals(this.subResult, facialSimilarityPhotoFullyAutoReport.subResult) &&
  ...
  public String toString() {
    ...
    sb.append("class FacialSimilarityPhotoFullyAutoReport {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FacialSimilarityPhotoFullyAutoReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FacialSimilarityPhotoFullyAutoReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in FacialSimilarityPhotoFullyAutoReport is not found in the empty JSON string", FacialSimilarityPhotoFullyAutoReport.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FacialSimilarityPhotoFullyAutoReport.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FacialSimilarityPhotoFullyAutoReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FacialSimilarityPhotoFullyAutoReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FacialSimilarityPhotoFullyAutoReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FacialSimilarityPhotoFullyAutoReport.class));

       return (TypeAdapter<T>) new TypeAdapter<FacialSimilarityPhotoFullyAutoReport>() {
           @Override
           public void write(JsonWriter out, FacialSimilarityPhotoFullyAutoReport value) throws IOException {
           ...
           @Override
           public FacialSimilarityPhotoFullyAutoReport read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FacialSimilarityPhotoFullyAutoReport instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of FacialSimilarityPhotoFullyAutoReport given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FacialSimilarityPhotoFullyAutoReport
   * @throws IOException if the JSON string is invalid with respect to FacialSimilarityPhotoFullyAutoReport
   */
  public static FacialSimilarityPhotoFullyAutoReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FacialSimilarityPhotoFullyAutoReport.class);
  }

  /**
   * Convert an instance of FacialSimilarityPhotoFullyAutoReport to an JSON string
   *
   * @return JSON string
   */
