...
public class DocumentBreakdownDataComparisonBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issuing_country", "gender", "date_of_expiry", "last_name", "document_type", "document_numbers", "first_name", "date_of_birth"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentBreakdownDataComparisonBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DocumentBreakdownDataComparisonBreakdown is not found in the empty JSON string", DocumentBreakdownDataComparisonBreakdown.openapiRequiredFields.toString()));
        }
      }
