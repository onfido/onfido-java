...
public class IdentityEnhancedBreakdown {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sources", "address", "date_of_birth", "mortality", "ssn", "ssn1"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdentityEnhancedBreakdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IdentityEnhancedBreakdown is not found in the empty JSON string", IdentityEnhancedBreakdown.openapiRequiredFields.toString()));
        }
      }
