...
public class PhotoReasons {
  ...
  public PhotoReasons digitalTampering(@javax.annotation.Nullable String digitalTampering) {
  ...
  public PhotoReasons fakeWebcam(@javax.annotation.Nullable String fakeWebcam) {
  ...
  public PhotoReasons timeOfCapture(@javax.annotation.Nullable String timeOfCapture) {
  ...
  public PhotoReasons emulator(@javax.annotation.Nullable String emulator) {
  ...
  public PhotoReasons reasons(@javax.annotation.Nullable String reasons) {
