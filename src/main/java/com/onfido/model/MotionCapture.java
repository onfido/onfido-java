...
public class MotionCapture {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created_at", "href", "download_href", "file_name", "file_size", "file_type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MotionCapture.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in MotionCapture is not found in the empty JSON string", MotionCapture.openapiRequiredFields.toString()));
        }
      }
